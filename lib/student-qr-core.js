...
function cfg() {
  return {
    stepMs: positiveInt(process.env.STUDENT_QR_FRAME_STEP_MS, 10000, 5000, 30000),
    graceMs: positiveInt(process.env.STUDENT_QR_GRACE_MS, 3000, 1000, 15000),
    sessionTtlSec: positiveInt(process.env.STUDENT_QR_SESSION_TTL_SEC, 180, 60, 600),
